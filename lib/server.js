...
// require('./api/resource/genre/router')
    ...
    console.log(__dirname + '/api/resource') 
    const resources =  fs.readdirSync(__dirname + '/api/resource')
    resources.forEach(function req(resource) {
      require('./api/resource/' +  resource + '/router.js')
    })
